...
<p align="center"> $CO_{2}$ (aq) + $H_{2}O$ ⇌ $H_{2}CO_{3}$ ⇌ $HCO_{3}^{-}$ + $H^{+}$ ⇌ C$CO_{3}^{2-}$ + $2H^{+}$

Carbon dioxide reacts with water to form carbonic acid:\
<p align="center"> $CO_{2}$ + $H_{2}O$ → $H_{2}CO_{3}$ </p>\
Carbonic acid is a weak acid that dissociates to form its conjugate bases bicarbonate and carbonate:\
<p align="center"> $H_{2}CO_{3}$ → $HCO_{3}^{-}$ + $H^{+}$ </p>\
<p align="center"> $HCO_{3}^{-}$ → $CO_{3}^{2-}$ + $H^{+}$ </p>\
